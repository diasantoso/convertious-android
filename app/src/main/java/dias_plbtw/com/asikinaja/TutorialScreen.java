...
public class TutorialScreen extends AppCompatActivity implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        file_maps.put("Youtubious Tutorial 1",R.drawable.tutor_3);
        file_maps.put("Youtubious Tutorial 2",R.drawable.tutor_2);
        file_maps.put("Youtubious Tutorial 3",R.drawable.tutor_1);

        for(String name : file_maps.keySet()){
            TextSliderView textSliderView = new TextSliderView(this);
            // initialize a SliderLayout
            textSliderView
                    .description("Youtubious Tutorial")
            ...
            textSliderView.getBundle()
                    .putString("extra","Youtubious Tutorial");
